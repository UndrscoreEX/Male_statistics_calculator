...
class Calculate_spec(View):
    ...
    def post(self, request):
        ...
        return render(request, 'results.html', {'results':clean_results} )

class Stats_en(View):
    def get(self, request):
        return render(request, 'stats_en.html')
...
class Calculate_spec_jp(View):
    ...
    def post(self, request):
        ...
        clean_results = Calc_form_specs(request)
        return render(request, 'results_jp.html', {'results':clean_results} )

class Stats_jp(View):
    def get(self, request):
        return render(request, 'stats_jp.html')
